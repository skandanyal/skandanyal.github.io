...
description: Performance modelling isn't just guess work. It is a science backed by iterative experimentation and evidence gained.
---
...
- **Peak Sustained Memory Bandwidth:** Measured using benchmarking suites like STREAM (specifically the Triad kernel). Refer to [this implementation](https://github.com/skandanyal/Glacier.HPC/STREAM) for detail.
...
Here is how a roofline model looks like: 

![Roofline model](/assets/blog4/roofline_plot.png)
