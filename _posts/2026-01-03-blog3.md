...
learner, the KNN kernel is only used during prediction and mostly never to train the model.
...
By following a structured optimization path, the KNN Classifier and Regressor implementations 
achieved upto 
