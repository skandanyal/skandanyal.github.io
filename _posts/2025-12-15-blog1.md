---
title: Building my own ML library  
data: 2025-12-15
--- 
...
Glacier.ML is a header-only machine learning library implemented entirely in C++. Eigen is used for linear algebra and Boost for statistical utilities.
